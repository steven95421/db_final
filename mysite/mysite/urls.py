...
urlpatterns = [
    ...
    re_path('anncs/delete/(?P<id>[^/]+)/', Home_views.anncs_delete),
    re_path('anncs/edit/(?P<id>[^/]+)/',  Home_views.anncs_edit),
    re_path('events/edit/(?P<id>[^/]+)/',  Home_views.events_edit),
    re_path('signup/(?P<id>[^/]+)/', Home_views.signup),
    re_path('home_anncs/(?P<id>[^/]+)/', Home_views.anncs),
    re_path('events/status/(?P<id>[^/]+)/', Home_views.events_status),
